...
PATHS = {
    'jm': {
        'cifar10': {
            ...
            'ckpt': '/home/sleitner/space/actmad/augmix_c10.pt',
        },
        'cifar100': {
            'root': '/mnt/linux_data/datasets/cifar100',
            'ckpt': '/home/sleitner/space/actmad/augmix_c100.pt',
        },
        'imagenet-mini': {
...
class ContextFilter:
    def filter(self, record):
        ...
        if split_name[0] == 'METHOD' or split_name[0] == 'MAIN':
            if len(split_name) > 1:
